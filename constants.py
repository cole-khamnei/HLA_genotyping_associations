...
UK_BIOBANK_CACHE_PATH = os.path.join(UK_BIOBANK_DATA_PATH, "cache")
...
UK_BIOBANK_HLA_ALLELES_TSV_FULL_PATH = os.path.join(UK_BIOBANK_DATA_PATH,
                                                    f"uk_biobank_{UK_BIOBANK_VERSION}_HLA_alleles_full.tsv")
