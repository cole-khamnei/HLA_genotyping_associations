...
class MedicalCodeMapping:
    ...
    def search_codes(self, search_terms: ArrayOrItem[str], fuzzy_threshold: int = 95,
                     and_search: bool = False) -> pd.DataFrame:
        """ Searches the descriptions of ICD codes for relevent features"""
        indices = utilities.fuzzy_index_search(search_terms, self.ICD10_master_list["meaning"].values,
                                               fuzzy_threshold=fuzzy_threshold, and_search=and_search)
